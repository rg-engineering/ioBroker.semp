...
class TimeframeWallbox extends base_1.default {
    deviceName;
    isActive;
    EarliestStart;
    LatestEnd;
    ...
    MinPower;
    MaxPower;
    SwitchOffAtEndOfTimer;
    WallboxChargeTimeEndles;
    WallboxChargeTime;
    CurrentEnergy;
    CurrentEnergyDiff;
    ID;
...
exports.default = TimeframeWallbox;
//# sourceMappingURL=TimeframeWallbox.js.map