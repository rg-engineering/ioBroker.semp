...
class TimeframeWallbox {
    ...
    Update() {
        ...
        this.MinEnergy = this.MinEnergy - this.CurrentEnergy;
        this.MaxEnergy = this.MaxEnergy - this.CurrentEnergy;
    ...
    getTimeframeData() {
        ...
        if (this.EarliestStart > 0 || this.LatestEnd > 0) {
            timeframeData = {
                ...
                //MaxPowerConsumption: this.MaxPowerConsumption ? this.MaxPower : 11000,
