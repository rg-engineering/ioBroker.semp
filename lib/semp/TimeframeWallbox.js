...
class TimeframeWallbox {
    ...
    constructor(settings, parentAdapter) {
        ...
        this.MinEnergy = -1;
        this.MaxEnergy = -1;
        this.MaxPowerConsumption = -1;
        this.MinPowerConsumption = -1;
    ...
    Start() {
        ...
        if (this.CanceledOnDay != dayOfWeek) {
            ...
            if (allchecked && runToday) {
                ...
                this.MinEnergy = 0;
                this.MaxEnergy = 7592;
                this.MaxPowerConsumption = 11000;
                this.MinPowerConsumption = 1380;
    ...
    getTimeframeData() {
        ...
        if (this.EarliestStart > 0 || this.LatestEnd > 0) {
            timeframeData = {
                ...
                MaxPowerConsumption: this.MaxPowerConsumption,
                MinPowerConsumption: this.MinPowerConsumption
            };
        }
