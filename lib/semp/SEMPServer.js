            ...
            if (d.planningRequest.Timeframe.length > 0) {
                for (let t = 0; t < d.planningRequest.Timeframe.length; t++) {
                    ...
                    const record =
                    {
                        ...
                        MinRunningTime: d.deviceInfo.DeviceType == "EVCharger" ? d.planningRequest.Timeframe[t].MinEnergy : d.planningRequest.Timeframe[t].MinRunningTime,
                        MaxRunningTime: d.deviceInfo.DeviceType == "EVCharger" ? d.planningRequest.Timeframe[t].MaxEnergy : d.planningRequest.Timeframe[t].MaxRunningTime
                    };
