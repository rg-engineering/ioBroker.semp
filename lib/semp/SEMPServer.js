        ...
        try {
            if (this.LogToCSV) {
                ...
                if (stats.isFile()) {
                    ...
                    //add file name
                    this.LogToCSVPath = this.LogToCSVPath + "/semp.csv";
                    isValid = true;
                ...
                const record = [
                    {
                        ...
                        AveragePower: d.deviceStatus.PowerConsumption.PowerInfo.AveragePower,
                        EarliestStart: d.planningRequest.Timeframe.length > 0 ? d.planningRequest.Timeframe[0].EarliestStart : -1,
                        LatestEnd: d.planningRequest.Timeframe.length > 0 ? d.planningRequest.Timeframe[0].LatestEnd : -1,
                        MinRunningTime: d.planningRequest.Timeframe.length > 0 ? d.planningRequest.Timeframe[0].MinRunningTime : -1,
                        MaxRunningTime: d.planningRequest.Timeframe.length > 0 ? d.planningRequest.Timeframe[0].MaxRunningTime : -1
                    }

                ];

                this.Gateway.parentAdapter.log.info("write to csv " + JSON.stringify(record));
