...
/*
    * auf Werteänderung (power) reagieren
    * ID nach Format F-11223344-112233445566-00
...
class Device {
    ...
    addPlanningRequest(earliestStart, latestEnd, minRunTime, maxRunTime) {
        ...
        this.Gateway.parentAdapter.log.debug("addPlanningRequest");
    ...
    clearPlanningRequests() {
        ...
        this.Gateway.parentAdapter.log.debug("clearPlanningRequests");
    ...
    getPlanningRequests() {
        ...
        this.Gateway.parentAdapter.log.debug("getPlanningRequests");
    ...
    setLastPower(watts, minPower, maxPower) {
        ...
        this.Gateway.parentAdapter.log.debug("setLastPower " + watts);
    ...
    sendEMRecommendation(em2dev) {
        ...
        this.Gateway.parentAdapter.log.debug("Send recommendation " + JSON.stringify(em2dev));
