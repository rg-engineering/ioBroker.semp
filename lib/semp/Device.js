...
class Device {
    ...
    constructor(gateway, device) {
        ...
        /*
        if (device.MinPowerConsumption) {
            this.deviceInfo.Characteristics.MinPowerConsumption = device.MinPowerConsumption;
        }
        else {
            this.deviceInfo.Characteristics.MinPowerConsumption = 0;
        }
        */
