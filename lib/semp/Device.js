 ...
 * 
 * plug connected bei start  funktioniert nicht
    ...
    */
    ...
    async startFastCharging() {
        ...
        if (this.isConnected) {
            ...
            this.SetState("fast charging");

            //device on
            await this.Switch(true);

            //max power 
            await this.setRecommendationPowerConsumption(this.deviceInfo.Characteristics.MaxPowerConsumption);

            //3phase check
            this.Check3PhaseCharge(this.deviceInfo.Characteristics.MaxPowerConsumption);
