		...
		switch (this.dishwasherstate) {
			...
			case this.states.waiting4OnRecommendation:
				...
				if (this.deviceStatus.Status == "Off") {
					this.Gateway.parentAdapter.log.debug(this.device.Name + " device is off after first on");

				}
				if (this.deviceStatus.Status == "On") {
					this.Gateway.parentAdapter.log.debug(this.device.Name + " device is on after first on");
				...
				*/
				...
				//notausgang 2 falls Gerät manuell wieder eingeschaltet wurde todo
