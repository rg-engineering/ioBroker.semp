...
class Device {
    ...
    setLastPower(watts, minPower, maxPower) {
        ...
        this.Gateway.parentAdapter.setState(key, { ack: true, val: this.EnergyData.SumEnergy });
...
*/
    ...
    CalcEnergy(watts) {
        this.Gateway.parentAdapter.log.debug(this.device.Name + " calc energy " + watts + " " + this.EnergyData.lastTimestamp);
        ...
        if (this.EnergyData.lastTimestamp>0){
            ...
            this.EnergyData.SumEnergy = this.EnergyData.SumEnergy + watts *  timeDiff/60/60; //in Wh          
            this.Gateway.parentAdapter.log.debug(this.device.Name + " calc energy " + this.EnergyData.SumEnergy + "Wh");
        }
