...
*/
    ...
    async CreateObject(key, obj) {
        ...
        this.Gateway.parentAdapter.log.debug(this.device.Name + " got object " + JSON.stringify(obj_new));
    ...
    async SetState() {
        ...
        if (currentState !== undefined && currentState != null) {
            ...
            this.Gateway.parentAdapter.log.error(this.device.Name + "  could not set state " + state + " on " + key);
        }
    }
