...
class Device {
    ...
    constructor(gateway,
        ...
        if (this.device.MaxPower === undefined || this.device.MaxPower == null ||this.device.MaxPower.length < 1) {
            this.Gateway.parentAdapter.log.error(this.device.Name + " max. Power not set!  " + this.device.MaxPower);
        ...
        if (this.device.Wallbox3phaseSwitchDelay === undefined || this.device.Wallbox3phaseSwitchDelay == null || this.device.Wallbox3phaseSwitchDelay <= 0) {
            this.Gateway.parentAdapter.log.error(this.device.Name + " wrong Wallbox3phaseSwitchDelay  " + this.device.Wallbox3phaseSwitchDelay);
