...
class Gateway {
    ...
    constructor(
        ...
        this.sempServer = new SEMPServer(uuid, ipAddress, sempPort, descriptionXml, this, parentAdapter.config.extendedLog);
    ...
    */
    ...
    setPowerDevice(id, power, statusdetection) {
        let d = this.getDevice(id);
        d.setLastPower(power, null, null, statusdetection);
    }
    ...
    updatePlanningRequest(reqId, id, earliestStart, latestEnd, minRunTime, maxRunTime) {

        let d = this.getDevice(id);
        d.updatePlanningRequest(reqId, earliestStart, latestEnd, minRunTime, maxRunTime)
    }

    getNoOfPlanningRequests(id) {

        let d = this.getDevice(id);
        return d.getNoOfPlanningRequests();
    }
    ...
    addDevice(device) {
        ...
        try {
            ...
            */
            ...
            let d = new Device(this, deviceId, name, type, measurementMethod, interruptionsAllowed,
                maxPower, emSignalsAccepted, status, vendor, serialNr, absoluteTimestamps,
                optionalEnergy, minOnTime, minOffTime);
                */
